...
public class Main
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		System.out.println("Generation    time:" + t2);
		System.out.println("Save/load     time:" + t3);
		System.out.println("Serialization time:" + t4);
		System.out.println("Jackson s/d   time:" + t5);
		// System.out.println(db);
